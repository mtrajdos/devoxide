...
print("Prerequisite 1: Raw .edf sleep recording")
print("Prerequisite 2: .csv with sleep stages as integers, use EdfProcessingForYASA.R")
print("Prerequisite 3: tkinter library for user-based file input")
print("Prerequisite 4: Definition of sampling frequency in Hertz [Hz]")
print("Prerequisite 5: Choice of a single EEG channel")
