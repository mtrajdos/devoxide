...
class MortgageCalculatorTests {
	...
	@Test
	void testMonthlyPaymentCanBeCalculated() throws Exception {
		DTO dto = new DTO(new BigDecimal("500000.00"), new BigDecimal("75000.00"), new BigDecimal("30"),
				new BigDecimal("0.04"));

		BigDecimal monthlyPrice = mortgageCalculatorService.calculateMortgageRate(dto);
		System.err.println(monthlyPrice);
